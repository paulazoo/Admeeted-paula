...
cred = credentials.Certificate("./admeeted-privatekey.json")
...
db.users.aggregate(
   [
{ $match: { "organization": "Harvard"} }
   ]
);

#%%
fee=db.collection("users").document("0JQunbpuKbcPpkA0hrN5").collection("feedback").get()
