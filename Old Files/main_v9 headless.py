...
def enter_email(web, email):
    ...
    try:
        ...
        element=web.find_element_by_css_selector("li[class*='eh XcEgrf fp pu hy']").click()
...
def create_hangout(web, subGroup, groupName, callNum, totalGroups):
    ...
    while notWorked:
        ...
        web.find_element_by_css_selector("span.Ce1Y1c").click()
        ...
        iframe_pls=web.find_elements_by_css_selector("iframe[aria-label=\"Contacts and conversations\"]")
