...
def init(excel_name):
    ...
    non_participating_indices = All_Summary[All_Summary['Will you join the Friday 3:00 PM EST call? If you select yes, please participate; otherwise, it hurts the experience for others. :) '].str.endswith("Yes") == False].index
    ...
    #no answer
    non_participating_indices2 = All_Summary[All_Summary['Will you join the Friday 3:00 PM EST call? If you select yes, please participate; otherwise, it hurts the experience for others. :) '].isnull()].index
